      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-20 lg:pt-24 lg:pb-28">
          <div className="max-w-3xl">
            <h1 className="text-4xl sm:text-5xl lg:text-[3.5rem] font-bold text-foreground tracking-tight leading-[1.1] animate-fade-in">
              The subscription marketplace for{' '}
              <span className="text-primary">global sellers</span>
            </h1>
            <p className="mt-6 text-lg sm:text-xl text-muted-foreground max-w-2xl leading-relaxed animate-fade-in-delay-1">
            ...
            <div className="mt-10 flex flex-wrap gap-4 animate-fade-in-delay-2">
              <Link
                href="/signup"
                className="btn-saas inline-flex items-center rounded-lg bg-primary px-6 py-3.5 text-base font-semibold text-primary-foreground shadow-lg hover:opacity-95"
              >
                Start free trial
              </Link>
              <Link
                href="/pricing"
                className="inline-flex items-center rounded-lg border border-border bg-background px-6 py-3.5 text-base font-semibold text-foreground hover:bg-muted transition-colors"
              >
                View pricing
              </Link>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {FEATURES.map((f, i) => (
              <div
                key={f.title}
                className={`card-feature rounded-xl bg-card p-6 ${i === 0 ? 'animate-fade-in-delay-1' : i === 1 ? 'animate-fade-in-delay-2' : i === 2 ? 'animate-fade-in-delay-3' : 'animate-fade-in-delay-3'}`}
              >
